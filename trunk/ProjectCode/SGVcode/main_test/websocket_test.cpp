...
void on_message(client* c, websocketpp::connection_hdl hdl, message_ptr msg) {
	...
	sip_client.send(hdl,"xxxxxxxxxxxxxx", websocketpp::frame::opcode::text);
}
...
int main(int argc, char* argv[]) {
	...
	try {
		...
		sip_client.set_open_handler(websocketpp::lib::bind(&on_open,&sip_client,::_1));
		sip_client.set_message_handler(websocketpp::lib::bind(&on_message,&sip_client,::_1,::_2));
