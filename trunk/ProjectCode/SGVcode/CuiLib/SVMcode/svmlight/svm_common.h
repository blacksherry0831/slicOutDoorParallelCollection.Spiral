...
typedef struct svector {
  WORDSV    *words;              /* The features/values in the vector by
...
SVECTOR *create_svector(WORDSV *, char *, double);
...
int    parse_document(char *, WORDSV *, double *, long *, long *, double *, long *, long, char **);
